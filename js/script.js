...
// This function generates a random color (in hexadecimal)
...
//This function checks if the selected object has only 2 keys or more (quote and source ) .It then renders the contents of the objects into the accordingly 
function printQuote() {
	...
	if (Object.keys(returnedObj).length === 2) {
		...
		document.getElementById("docBody").style.backgroundColor = randomColor
	} else {
